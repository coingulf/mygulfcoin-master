...
const string strMessageMagic = "MyGulfCoin Signed Message:\n";
  ...
  if(pindexBest->nHeight+1 >= 1 && pindexBest->nHeight+1 <= 1)
{
  ...
  else if(pindexBest->nHeight+1 >= 2 && pindexBest->nHeight+1 <= 9999999)
{
  nSubsidy = 0 * COIN;
}
...
// MyGulfCoin: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MyGulfCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "My Gulf Coin 2017";
        CTransaction txNew;
        txNew.nTime = 1493051603;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xbfcd2263e92e480e851007c6adf51f8a3d7203d5ff32e9ed0f33732b946f87c9"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xd2, 0x2a, 0xb3, 0xf5 };
